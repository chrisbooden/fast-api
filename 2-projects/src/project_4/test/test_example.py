...
def test_person_initialization():
    ...
    assert p.major == "Computer Science", "First name should be Computer Science"
    assert p.years == 3
...
def test_person_init(default_employee):
    ...
    assert default_employee.major == "Computer Science", "First name should be Computer Science"
